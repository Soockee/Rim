...
import (
	...
	"github.com/MakeRequests/services/route"
)
...
func init() {
	...
	routeCmd.Flags().StringVarP(&routeOptions.serverInterface, "bind", "", "hotrod-route", "interface to which the Route server will bind")
